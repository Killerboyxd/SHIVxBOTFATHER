...
HELP_PIC = "https://telegra.ph/file/f627873ed3dc636243f81.jpg"

RyanHelp = "★ 𝙎𝙝𝙞𝙫𝙓𝙎𝙥𝙖𝙢 𝙃𝙚𝙡𝙥 𝙈𝙚𝙣𝙪 ★\n𝐂𝐥𝐢𝐜𝐤 𝐎𝐧 𝐁𝐞𝐥𝐨𝐰 𝐁𝐮𝐭𝐭𝐨𝐧𝐬 𝐅𝐨𝐫 𝐇𝐞𝐥𝐩\n\n\n@ll_SABKA_BHAI_KILLER_ll"
...
async def help(event):
    if event.sender_id in SUDO_USERS:
       await event.client.send_file(event.chat_id,
           ...
           [    
            Button.url("✨ ᴄʜᴀɴɴᴇʟ ✨", "https://t.me/ll_SABKA_BHAI_KILLER_ll")
           ],
           [
           Button.url("✨ sᴜᴘᴘᴏʀᴛ ✨", "https://t.me/RONNY_KI_DUNIYA")
           ],
           ],
           )              
...
async def helpback(event):
   if event.query.user_id in SUDO_USERS:    
      await event.edit(
        ...
        Alert = (
                "Noob !! Make Your Own Shiv X Spam Bots !! @ll_SABKA_BHAI_KILLER_ll"
            )
